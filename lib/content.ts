...
export const ramos: Ramo[] = [
  ...
  },
  {
    ...
    group: "particular",
    title: "Accidentes",
    blurb: "Accidentes personales y deportivos. Cobertura para practicantes, monitores, guías y profesionales del deporte.",
    highlights: ["Accidentes deportivos", "Invalidez y fallecimiento", "Asistencia especializada"],
    cta: "Cotizar accidentes",
  },
  {
    slug: "rc-autonomos",
    group: "profesional",
    title: "RC autónomos",
    blurb: "Responsabilidad civil para autónomos, profesionales colegiados y oficios. Defensa jurídica incluida.",
    highlights: ["RC profesional", "Defensa jurídica", "Prima anual o trimestral"],
    cta: "Cotizar RC autónomo",
  },
  {
    slug: "rc-empresas",
    group: "empresa",
    title: "RC empresas",
    blurb: "Responsabilidad civil de explotación, patronal y profesional para empresas y pymes.",
    highlights: ["RC explotación", "RC patronal", "Defensa jurídica"],
    cta: "Cotizar RC empresa",
  },
  {
    slug: "empresa-pyme",
    group: "empresa",
